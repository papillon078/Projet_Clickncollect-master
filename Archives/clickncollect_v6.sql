...
CREATE TABLE ll7882_users(
        ...
        loyalty_card      Int  Auto_increment  NOT NULL ,
...
CREATE TABLE command_line(
	...
	,CONSTRAINT command_line_PK PRIMARY KEY (id,id_ll7882_items)

	,CONSTRAINT command_line_ll7882_orders_FK FOREIGN KEY (id) REFERENCES ll7882_orders(id)
