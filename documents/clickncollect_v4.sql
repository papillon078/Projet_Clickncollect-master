...
#------------------------------------------------------------
# Table: timeslot_allocations
#------------------------------------------------------------

CREATE TABLE timeslot_allocations(
        id              Int  Auto_increment  NOT NULL ,
        slot_allocation Time NOT NULL
	,CONSTRAINT timeslot_allocations_PK PRIMARY KEY (id)
)ENGINE=InnoDB;
...
CREATE TABLE orders(
        ...
        id_timeslot_allocations Int NOT NULL
	...
	,CONSTRAINT orders_timeslot_allocations1_FK FOREIGN KEY (id_timeslot_allocations) REFERENCES timeslot_allocations(id)
	,CONSTRAINT orders_users_AK UNIQUE (id_users)
	,CONSTRAINT orders_timeslot_allocations0_AK UNIQUE (id_timeslot_allocations)
)ENGINE=InnoDB;
